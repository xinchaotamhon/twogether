...
The 12 cards under `content/cards.json` remain explicitly project-owned fixtures. The owner-pasted Claude captures are summarized under `content/sources/`, with 10 derived cards held safely in `content/drafts/` for Human review; they are not loaded into the runtime yet.
