...
4. Add browser-level keyboard/focus/reveal-order/map-list parity tests and a real installability check; keep existing 7/7 focused tests and all 8/8 cumulative smoke gates required.
